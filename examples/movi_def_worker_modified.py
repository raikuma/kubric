...
parser.add_argument("--max_num_static_objects", type=int, default=1,
...
parser.add_argument("--camera", choices=["fixed_random", "linear_movement", "spheric_movement"],
                    default="spheric_movement")
parser.add_argument("--max_camera_movement", type=float, default=4.0)
parser.add_argument("--max_motion_blur", type=float, default=0.0)
parser.add_argument("--max_camera_angle", type=float, default=60.0)
...
parser.add_argument("--simulation_steps", type=int, default=0)
...
_, _ = simulator.run(frame_start=-FLAGS.simulation_steps, frame_end=0)
